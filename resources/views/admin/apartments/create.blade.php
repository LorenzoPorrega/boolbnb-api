            ...
            <div class="col-8">
                ...
                <form action="{{ route('admin.apartments.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" value="{{ old('bathroom_num') }}"
                                name="bathroom_num">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9 d-flex flex-row">
                            <div class="d-flex" style="width: fit-content">
                                <input type="radio" name="visibility" value="1" class="form-check-input mx-1"
                                    @if (old('visibility') == 1) checked @endif> Visibile
                            </div>
                            <div class="d-flex" style="width: fit-content">
                                <input type="radio" name="visibility" value="0" class="form-check-input mx-1"
                                    @if (old('visibility') == 0) checked @endif> Non Visibile
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        @if ($singleAmenity->category == $singleCategory['category'])
                                                            <div>
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="{{ $singleAmenity->id }}" id="flexCheckDefault"
                                                                    name="amenity[]">
