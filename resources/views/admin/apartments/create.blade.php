            ...
            <div class="col-8">
                <form action="{{ route('admin.apartments.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" value="{{ old('title') }}" id="title"
                                name="title" required oninput="validateInputs('title', 'title-error')">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror --}}
                        <div id="input">
                            <input type="text" class="form-control d-none" value="{{ old('address') }}" id="address"
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" value="{{ old('price') }}" id="price"
                                name="price" required oninput="validateInputs('price', 'price-error')">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" accept="image/*" class="form-control" id="images" name="images[]"
                            multiple="multiple" required oninput="validateInputs('images', 'image-error')">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div>
                            <input type="text" class="form-control" value="{{ old('rooms_num') }}" id="rooms_num"
                                name="rooms_num" required oninput="validateInputs('rooms_num', 'rooms-error')">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div>
                            <input type="text" class="form-control" value="{{ old('beds_num') }}" id="beds_num"
                                name="beds_num" required oninput="validateInputs('beds_num', 'beds-error')">
                        </div>
                    </div>
                        ...
                        <div class="row w-100">
                            <div>
                                <input type="radio" name="visibility" value="1" class="form-check-input mx-1"
                                    @if (old('visibility') == 1) checked @endif>Already visible
                            </div>
                            <div>
                                <input type="radio" name="visibility" value="0" class="form-check-input mx-1"
                                    @if (old('visibility') == 0) checked @endif>Hidden for now
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div>
                            <input type="text" class="form-control" value="{{ old('square_meters') }}"
                                id="square_meters" name="square_meters" required
                                                        ...
                                                        @if ($singleAmenity->category == $singleCategory['category'])
                                                            <div>
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    id="flexCheckDefault{{ $singleAmenity->id }}"
                                                                    name="amenity[]">
                                                                <label class="form-check-label"
                                                                    for="flexCheckDefault{{ $singleAmenity->id }}">
                                                                    {{ $singleAmenity->name }}
                                                                </label>
                                                            </div>
                                                        @endif
